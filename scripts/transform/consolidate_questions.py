...
def consolidate_questions(
    group, years_files, qcon_map, rescon_mapping, canon_to_over_map, output_file, preferred_order=None, fixed_cols=None
):
    ...
    merged = (
        merged.groupby("School Year", group_keys=False, sort=False, observed=False)
...
def batch_consolidate_questions(groups, years_list, data_root, qcon_map, rescon_mapping, canon_to_over_map):
    for group in groups:
